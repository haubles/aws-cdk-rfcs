...
*Original Author(s)*: @haubles, @billfine
...
This RFC also kicks off a period of community input about the Council and its Charter, which will last for 30 days. On February 10, 2025, we will incorporate the feedback shared on the tracking issue and ratify the Charter by merging it to the CDK repository.
...
If you are interested in joining a working group, or have an idea for one not listed here, please fill out this form.
...
* Community input will be gathered from the TRACKING-ISSUE and the   
